...
const Header = () => {
    return (
        <header className="bg-blue-600 w-full h-16 flex items-center">
            <article className="text-white text-lg tracking-wide font-bold flex items-center justify-between w-full px-5">
