        ...
        <div class="w-full h-full">
            ...
            <main class="flex w-full border-2 border-black h-screen">
                ...
                <section class="w-full h-full flex flex-col items-center justify-center bg-white">
                    <article class="w-full h-75 flex items-center justify-around gap-8">
                        <button (click)="handleRedirect('colors')" class="border-2 border-black max-w-lg md:w-[26rem] h-64 rounded-2xl text-3xl font-bold bg-blue-600 text-white cursor-pointer flex flex-col justify-center items-center gap-4 hover:bg-gray-200 hover:text-black hover:border-blue-700 transition-colors duration-200">
                            Cambiar Colores
                        ...
                        <button (click)="handleRedirect('typography')" class="border-2 border-black max-w-lg md:w-[26rem] h-64 rounded-2xl text-3xl font-bold bg-blue-600 text-white cursor-pointer flex flex-col justify-center items-center gap-4 hover:bg-gray-200 hover:text-black hover:border-blue-700 transition-colors duration-200">
                            Cambiar Tipografia
                        ...
                        <button (click)="handleRedirect('users')" class="border-2 border-black max-w-lg md:w-[26rem] h-64 rounded-2xl text-3xl font-bold bg-blue-600 text-white cursor-pointer flex flex-col justify-center items-center gap-4 hover:bg-gray-200 hover:text-black hover:border-blue-700 transition-colors duration-200">
                            Usuarios
