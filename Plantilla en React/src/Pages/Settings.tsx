...
const Settings: React.FC = () => {
  ...
  const navigate = useNavigate(); // <-- Esto es fundamental
      ...
      switch (field) {
        ...
        case "phone_user":
          if (
            ...
            newErrors[field] =
              "El teléfono debe ser numérico y tener entre 7 y 15 dígitos";
          }
          break;
        case "age_user":
        ...
        case "card_number_user":
          if (
            ...
            newErrors[field] =
              "El número de tarjeta debe ser numérico y tener entre 12 y 19 dígitos";
          }
          break;
        case "card_expire_user":
          if (
            !value ||
            typeof value !== "string" ||
            !/^(0[1-9]|1[0-2])\/\d{2,4}$/.test(value)
          ) {
            newErrors[field] =
              "La fecha de expiración debe tener formato MM/AA o MM/AAAA";
          }
          break;
        case "iban_user":
